...
function creatReq() {
    ...
    var url = 'http://'+path + "public/visit";
    //alert(url);
    ...
    // if (req) {
       ...
       // req.onreadystatechange = callback; // 制定回调函数      
        ...
        url = url + "?id=" + escape(link) + "&oldlink=" + escape(oldlink)+ "&sys=" + getSysInfo() + "&s=" + screen + "&b=" + GetBrowserType() + " " + GetBrowserVersion() + "&p=" + remote_ip_info.province + "&c=" + remote_ip_info.city + "&k=" + GetKeyword(oldlink);
        $.get(url,{},function(msg){
        })
        // req.open("GET", url + "?id=" + escape(link) + "&oldlink=" + escape(oldlink) + "&title=" + escape(titleName) + "&sys=" + getSysInfo() + "&s=" + screen + "&b=" + GetBrowserType() + " " + GetBrowserVersion() + "&p=" + remote_ip_info.province + "&c=" + remote_ip_info.city + "&k=" + GetKeyword(oldlink);
        //     , true);
    // }
}
